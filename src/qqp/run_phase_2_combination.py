...
from .pareto import (
    save_pareto_table,
    plot_energy_accuracy_combination,
    plot_energy_f1_combination,
    plot_energy_latency_combination,
)
...
def parse_arguments() -> argparse.Namespace:
    ...
    # Default to full QQP validation coverage (40430 examples ~= 632 batches @64)
...
def run_phase_2_combination_sweep() -> None:
    ...
    for precision in args.precisions:
        ...
        for max_sequence_length in args.sequence_lengths:
            ...
            if max_sequence_length not in tokenized_validation_by_length:
                tokenized_validation_by_length[max_sequence_length] = load_and_tokenize_qqp_validation(
    ...
    _ = plot_energy_f1_combination(pareto_csv_path, run_directory)
