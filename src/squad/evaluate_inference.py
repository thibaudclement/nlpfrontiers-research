...
def postprocess_qa_predictions(
    ...
    # Generate prediction per example by searching best spans across features
        ...
        for feature_index in feature_indices:
            ...
            for start_index in start_indexes:
                for end_index in end_indexes:
                    # Skip out-of-range or non-context tokens
...
def benchmark_inference_qa(
    ...
    # DataLoader over validation features (windows), not raw examples
    loader = DataLoader(validation_features, batch_size = evaluation_batch_size, shuffle = False)
    ...
    # Compute latency and energy normalized per validation example (not per feature)
...
# Build inference autocast context for specified precision
...
# Run QA inference benchmark with specified precision
